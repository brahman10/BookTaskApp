...
class SignUpViewModel @Inject constructor(
    ...
    fun login(){
        viewModelScope.launch {
            loginLiveData.postValue(db.loginDao().getUser(
                username,
                password
            ))
        }
    ...
    fun saveDataIntoPreference(loginEntity: LoginEntity){
        appPreferences.username = loginEntity.name
    }
